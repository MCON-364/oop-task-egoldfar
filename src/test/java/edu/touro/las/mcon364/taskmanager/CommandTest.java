...
class CommandTest {
    ...
    void testAddTaskCommand() {
        ...
        assertTrue(registry.get("New task").isPresent(), "Task should be in registry after AddTaskCommand");
        assertEquals(task, registry.get("New task").orElseThrow(), "Added task should match");
    }
    ...
    void testAddTaskCommandReplacement() {
        ...
        assertEquals(Priority.HIGH, registry.get("Task").orElseThrow(() -> new TaskNotFoundException("No such Task")).priority(),
    ...
    void testUpdateTaskCommand() {
        ...
        command.execute();
        assertDoesNotThrow(() -> registry.get("Update me").orElseThrow(TaskNotFoundException::new), "Task should still exist after update");
    ...
    void testUpdateTaskCommandPreservesName() {
        ...
        command.execute();
        assertDoesNotThrow(() -> registry.get("Important task").orElseThrow(TaskNotFoundException::new), "Task should still exist after update");
    ...
    void testUpdateTaskCommandPriorityDecrease() {
        ...
        assertEquals(Priority.LOW, registry.get("Flexible").orElseThrow(TaskNotFoundException::new).priority(),
    ...
    void testUpdateTaskCommandPriorityIncrease() {
        ...
        assertEquals(Priority.HIGH, registry.get("Urgent").orElseThrow(TaskNotFoundException::new).priority(),
