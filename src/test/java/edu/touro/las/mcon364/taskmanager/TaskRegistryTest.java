...
class TaskRegistryTest {
    ...
    void testAdd() {
        ...
        assertTrue(registry.get("Test task").isPresent(), "Added task should be retrievable");
        assertEquals(task, registry.get("Test task").orElseThrow(), "Retrieved task should equal added task");
    }
